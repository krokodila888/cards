...
function EditFlowerForm (props) {
  ...
  return(
    <>
      <p className="editFlowerForm__title">
        Изменить данные цветка
      </p>
      {plants !== undefined && currentFlower !== null && currentFlower !== '' &&
      <form 
        onSubmit={handleSubmit} 
        id="editFlowerForm__form" 
        className="editFlowerForm__container">
        <input 
          required 
          ...
          className="editFlowerForm__text editFlowerForm__row-container" 
    ...
    {(userDataRequestRes.chat_id !== '' && form.notification && tlg) && (
      <>
        <p>Спасибо! Теперь зайдите в <span className="editFlowerForm__botLink" onClick={handleLinkClick}>наш бот </span>и скажите ему что-нибудь, чтобы он мог отправлять Вам сообщения</p>
      </>
    )}
